    ...
    const fetchUserDetails = async () => {
      try {
        ...
        const navItems = [
          ...
          { text: 'Members', icon: <People />, action: 'members', permissionKey: null },
          { text: 'Analytics', icon: <People />, action: 'analytics', permissionKey: null },
          {
            text: 'Plan',
            icon: <Assignment />,
            ...
            permissionKey: null,
            subItems: [
              { text: 'Month Plan', icon: <Assignment />, action: 'plan', permissionKey: null },
              { text: 'Member Plan', icon: <Assignment />, action: 'mplan', permissionKey: null },
            ],
          },
          {
            text: 'Task',
            ...
            permissionKey: null,
            subItems: [
              { text: 'Member Task', icon: <Task />, action: 'mtask', permissionKey: null },
              { text: 'My Task', icon: <Task />, action: 'mytask', permissionKey: null },
            ],
          },
