      ...
      try {
        ...
        const navItems = [
          { text: 'Dashboard', icon: <Dashboard />, action: 'dashboard', permissionKey: null },
           { text: 'Analytics', icon: <AnalyticsIcon />, action: 'analytics', permissionKey: null }, // No permission required for dashboard
          { text: 'Invitations', icon: <MarkEmailUnread />, action: 'invitation', permissionKey: null },
          { text: 'Availability', icon: <EventAvailable />, action: 'availble', permissionKey: null },
