  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const usersData1 = await selectDataProfiles({ company_id: userData.company_id, role: 'user' });
        const usersData2 = await selectDataProfiles({ company_id: userData.company_id, role: 'tablet' });
  
        // Combine the data from usersData1 and usersData2
        const combinedData = [...usersData1.data, ...usersData2.data];
