...
import { Brightness4, Brightness7, VpnKey as ApiKeyIcon, Close as CloseIcon, CheckCircle as CheckCircleIcon, Notifications as NotificationsIcon, Event as EventIcon } from '@mui/icons-material';
  ...
  useEffect(() => {
    const fetchUserDetails = async () => {
      try {
        ...
        const eventSource = new EventSource(`http://10.33.80.158:5000/updates?userId=${userId}`, {
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={3}>
              <Paper sx={{ p: 1, display: 'flex', alignItems: 'center', gap: 2, boxShadow: 'none', outline: 'none' }}>
                ...
                <Box>
                  <Typography sx={{ fontSize: 13 }} variant="h6">Company : SyncUP Platform</Typography>
                </Box>
              </Paper>
            </Grid>
            <Grid item xs={12} md={3}>
              <Paper sx={{ p: 1, display: 'flex', alignItems: 'center', gap: 2, boxShadow: 'none', outline: 'none' }}>
                ...
                <Box>
                  <Typography sx={{ fontSize: 13 }} variant="h6">Active Plan : Super Admin</Typography>
                </Box>
              </Paper>
            </Grid>
